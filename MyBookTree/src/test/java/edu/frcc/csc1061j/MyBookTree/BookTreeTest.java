...
public class BookTreeTest 
{
	...
	public static void main(String[] args) 
	{
		...
		book.addBookNode("SubSection 5.3.5", 5, 3, 5);
		book.addBookNode("SubSection 4.2.4", 4, 2, 4);
		book.addBookNode("SubSection 2.1.3", 2, 1, 3);
		book.addBookNode("SubSection 1.4.2", 1, 4, 2);
		book.addBookNode("SubSection 3.5.1", 3, 5, 1);
